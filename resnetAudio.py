...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=cfg.class_num, zero_init_residual=False,
        ...
        # if self.args["learn"]["method"]=="Contrastive" or self.args["learn"]["method"]=="ConsistencyReg":
        #     self.fc2 = nn.Linear(512 * block.expansion, args["learn"]["low_dim"])
